    ...
    <div className="container-app py-8 sm:py-16">
      ...
      <div className="mx-auto mt-8 max-w-4xl text-center">
        ...
        <h1 className="mt-2 text-display-sm font-extrabold text-ink-900 sm:text-display-md">
          Souhaitez-vous payer les frais de réservation ou demander une visite ?
        </h1>
        <div className="mt-9 grid gap-5 sm:grid-cols-2">
          <Choice href={`/appartements/${property.slug}/reserver`} icon={CreditCard} title="Payer la réservation" description="Remplissez votre dossier pour régler les frais de réservation." />
